...
import com.qozix.tileview.paths.LinePathView;
...
public class TileView extends ZoomPanLayout implements
    ...
    private MarkerLayout mPinLayout;
    ...
    public TileView(Context context, AttributeSet attrs, int defStyleAttr ) {
        ...
        mLinePathView = new LinePathView(context);
        addView(mLinePathView);
        ...
        mPinLayout = new MarkerLayout(context);
        addView(mPinLayout);
    ...
    public MarkerLayout getPinLayout() {
        return mPinLayout;
    }
    ...
    /**
     * Scrolls (instantly) the TileView to the x and y positions provided,
     * then centers the viewport to the position without constrains.
     *
     * @param x The relative x position to move to.
     * @param y The relative y position to move to.
     */
    public void scrollToUnbounded(double x, double y) {
        scrollToAndBottomUnbounded(
                mCoordinateTranslater.translateAndScaleX(x, getScale()),
                mCoordinateTranslater.translateAndScaleY(y, getScale())
        );
    }
    ...
    public void onScaleChanged(float scale, float previous) {
        ...
        mLinePathView.setScale( scale );
        mMarkerLayout.setScale( scale );
        mPinLayout.setScale( scale );
